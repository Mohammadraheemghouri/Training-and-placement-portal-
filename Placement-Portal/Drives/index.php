		...
		<div class="banner">
			...
			<div class="container">
				<div class="header">
					...
					<div class="top-nav">
						<span class="menu">
							<img src="https://img.collegedekhocdn.com/media/img/institute/crawled_images/CVR_College_of_Engineering5.jpg?tr=h-390,w-262" alt="">
						</span>
						<ul class="nav1">
				...
				<div class="col-md-7 specialty-grids">
					...
					<div class="specialty-grids-top">
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							...
							<p>Creating Oppourtunities and Encouraging to Evolve.</p>
						</div>
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<figure class="icon">
		...
		<div class="testimonials">
			<div class="container">
				<div class="testimonial-nfo wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Our Motto</h3>
					<h5>We Just Learn with you and we give you a Platform to Improve Yourself</span>
					</h5>
				</div>
